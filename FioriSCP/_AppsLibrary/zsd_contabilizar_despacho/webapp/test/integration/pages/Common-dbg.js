sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("conchaytoro/cl/zsd_contabilizar_despacho/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("conchaytoro.cl.zsd_contabilizar_despacho.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["conchaytoro/cl/zsd_contabilizar_despacho/localService/mockserver"], function (mockserver) {
