sap.ui.define([
	...
	return BaseObject.extend("cl.conchaytoro.zpp_aprobar_reclasificacion.model.GroupSortState", {
		 ...
		 * @alias cl.conchaytoro.zpp_aprobar_reclasificacion.model.GroupSortState
		 */
		...
		/**
		 * Groups by CantCab, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "CantCab") {
				...
				this._oViewModel.setProperty("/sortBy", "CantCab");

				aSorters.push(
					new Sorter("CantCab", false,
