...
sap.ui.define([
		...
		"cl/conchaytoro/zpp_aprobar_reclasificacion/model/grouper",
		...
		return BaseController.extend("cl.conchaytoro.zpp_aprobar_reclasificacion.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("cl.conchaytoro.zpp_aprobar_reclasificacion.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("CantCab", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("CantCab", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sObjectId = mParams.firstListitem.getBindingContext().getProperty("Aufnr");
