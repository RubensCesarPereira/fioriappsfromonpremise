sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("cl/conchaytoro/zpp_aprobar_reclasificacion/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("cl.conchaytoro.zpp_aprobar_reclasificacion.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["cl/conchaytoro/zpp_aprobar_reclasificacion/localService/mockserver"], function (mockserver) {
