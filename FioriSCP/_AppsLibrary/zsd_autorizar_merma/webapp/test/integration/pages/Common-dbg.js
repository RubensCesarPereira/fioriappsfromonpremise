sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("conchaytoro/cl/zsd_autorizar_merma/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("conchaytoro.cl.zsd_autorizar_merma.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["conchaytoro/cl/zsd_autorizar_merma/localService/mockserver"], function (mockserver) {
