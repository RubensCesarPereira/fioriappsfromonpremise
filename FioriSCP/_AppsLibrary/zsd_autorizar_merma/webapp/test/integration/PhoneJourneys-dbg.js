...
sap.ui.require([
	...
	sap.ui.require([
		"conchaytoro/cl/zsd_autorizar_merma/test/integration/NavigationJourneyPhone",
		"conchaytoro/cl/zsd_autorizar_merma/test/integration/NotFoundJourneyPhone",
		"conchaytoro/cl/zsd_autorizar_merma/test/integration/BusyJourneyPhone"
	], function () {
		QUnit.start();
	});
});