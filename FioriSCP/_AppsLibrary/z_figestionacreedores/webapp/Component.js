sap.ui.define([
	...
	return UIComponent.extend("z_figestionacreedores.Component", {
		...
		metadata: {
			manifest: "json",
				 stereotype 	: "component", 
			        "abstract"	: true,  
			        version 	: "1.0",   
			        library 	: "z_figestionacreedores", 	         //required for CSS reference
...
//			gv_i18nBundle = jQuery.sap.resources({url : lv_oBundle.oData.bundleUrl});
		...
		get_i18nProperties: function(){				
		    ...
		    */	
		    ...
		    var lv_bundleUrl = $.sap.getModulePath("z_figestionacreedores", lv_i18nPath);   
