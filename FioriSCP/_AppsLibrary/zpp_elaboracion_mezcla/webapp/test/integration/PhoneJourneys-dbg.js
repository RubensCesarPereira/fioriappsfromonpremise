...
sap.ui.require([
	...
	sap.ui.require([
		"cl/conchaytoro/zpp_elaboracion_mezcla/test/integration/NavigationJourneyPhone",
		"cl/conchaytoro/zpp_elaboracion_mezcla/test/integration/NotFoundJourneyPhone",
		"cl/conchaytoro/zpp_elaboracion_mezcla/test/integration/BusyJourneyPhone"
	], function () {
		QUnit.start();
	});
});