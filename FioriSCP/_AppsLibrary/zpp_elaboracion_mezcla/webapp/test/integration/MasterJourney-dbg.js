...
sap.ui.define([
	...
	opaTest("MasterList Filtering on Gsmng less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<Gsmng>").
			and.iSelectListItemInViewSettingsDialog("<100 <Cuba>").
	...
	opaTest("MasterList Filtering on Gsmng more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <Cuba>").
			and.iPressOKInViewSelectionDialog();
