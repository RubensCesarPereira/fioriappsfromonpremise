sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("cl/conchaytoro/zpp_elaboracion_mezcla/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("cl.conchaytoro.zpp_elaboracion_mezcla.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["cl/conchaytoro/zpp_elaboracion_mezcla/localService/mockserver"], function (mockserver) {
