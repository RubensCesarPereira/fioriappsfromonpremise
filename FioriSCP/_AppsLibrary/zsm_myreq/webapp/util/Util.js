	...
	return {
		...
		checkCreationMode: function() {
			...
			if (sap.ushell && sap.ushell.Container && sap.ushell.Container.getService) {
				...
				// var oPromise = oCrossAppNavigator.getSemanticObjectLinks( { target: { semanticObject : "Action", action: "SMCreateIncident" }});
		...
		getBusyDialog: function(id, oTitle, oView, context) {
			...
			// instantiate dialog
			if (!oDialog) {
				oDialog = sap.ui.xmlfragment(id, "zsm.itsm.myreq.cust.view.fragments.BusyDialog", context);
