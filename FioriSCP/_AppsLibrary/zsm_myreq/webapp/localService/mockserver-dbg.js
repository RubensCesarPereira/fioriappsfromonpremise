...
sap.ui.define([
	...
	var oMockServer,
		_sAppModulePath = "zsm/itsm/myreq/cust/",
	...
	return {
						...
						"error": {
							...
							"innererror": {
								"application": {
									...
									"service_id": "ZAI_CRM_GW_MYREQUIREMENTS_SRV",
				...
				response: function(oXhr, sUrlParams) {
					...
					oXhr.respondJSON(200, {}, JSON.stringify({
						...
						"d": {
							"withdrawIncident": {
								"__metadata": {
									"type": "ZAI_CRM_GW_MYREQUIREMENTS_SRV.BAPIRET"
								},
								"Type": "E",
								"Id": "CRM_ORDER_MISC",
								"Number": "104",
		...
		afterPost: function(oEvent) {
			...
			if (oEvent.getParameter("oEntity").__metadata.type === "ZAI_CRM_GW_MYREQUIREMENTS_SRV.Text") {
			...
			} else if (oEvent.getParameter("oEntity").__metadata.type === "ZAI_CRM_GW_MYREQUIREMENTS_SRV.Attachment") {
