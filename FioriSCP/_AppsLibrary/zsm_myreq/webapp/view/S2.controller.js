...
sap.ui.define([
	...
	"zsm/itsm/myreq/cust/util/TableOperations"
	...
	return BaseController.extend("zsm.itsm.myreq.cust.view.S2", {
		...
		onInit: function() {
			...
			var aFilterItems = {
				itemsFilter: [{
					...
					text: this.bundle.getText("FILTER_DISPATCHED"),
					key: "Transferred"
				}, {
					...
					text: this.bundle.getText("FILTER_CHRA"),
					key: "ChangeProgress"
				}, {				
					...
					text: this.bundle.getText("FILTER_SENT_SAP"),
					key: "SendtoSap"
				}]
		...
		onMessageCreateExtern: function(sChannelId, sEventId, oData) {
			...
			if (sap.ushell && sap.ushell.Container && sap.ushell.Container.getService) {
				...
				var semanticObject = "ZMyRequeriments";
				var action = "display";
				...
				jQuery.sap.log.info("Cannot Navigate - Application Running Standalone" , null , "zsm.itsm.myreq.cust");
			}
		...
		navigateToExtCreation: function() {
			if (sap.ushell && sap.ushell.Container && sap.ushell.Container.getService) {
				...
				sap.ui.getCore().getEventBus().subscribeOnce("zsm.itsm.createrequirement.cust", "afterCreate", this.onMessageCreateExtern, this);
				sap.ui.getCore().getEventBus().subscribeOnce("zsm.itsm.createrequirement.cust", "afterCancel", this.onMessageCancelExtern, this);
				...
				oCrossAppNavigator.toExternal({
					target: {
						semanticObject: "ZCreateRequirementSem",
						action: "create"
					}
		...
		handleFilterChange: function(evt) {
			...
			var filterMap = {
				...
				"Transferred": new sap.ui.model.Filter("Concatstatuser",
					sap.ui.model.FilterOperator.EQ, "DISPATCHED"),
				...
				"ChangeProgress": new sap.ui.model.Filter("Concatstatuser",
					sap.ui.model.FilterOperator.EQ, "CHRA"),
				...
				"SendtoSap": new sap.ui.model.Filter("Concatstatuser",
					sap.ui.model.FilterOperator.EQ, "SENT_SAP")
			};
