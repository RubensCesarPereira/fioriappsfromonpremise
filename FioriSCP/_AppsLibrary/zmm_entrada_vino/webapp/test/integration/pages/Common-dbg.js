sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("cl/conchaytoro/zmm_entrada_vino/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("cl.conchaytoro.zmm_entrada_vino.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["cl/conchaytoro/zmm_entrada_vino/localService/mockserver"], function (mockserver) {
