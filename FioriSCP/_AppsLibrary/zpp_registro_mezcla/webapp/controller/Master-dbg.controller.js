...
sap.ui.define([
		...
		return BaseController.extend("cl.conchaytoro.zpp_registro_mezcla.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("Erdat", FilterOperator.Contains, sQuery)];
				} else {
