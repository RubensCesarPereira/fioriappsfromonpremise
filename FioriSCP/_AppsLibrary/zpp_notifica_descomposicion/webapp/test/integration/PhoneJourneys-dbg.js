...
sap.ui.require([
	...
	sap.ui.require([
		"cl/conchaytoro/zpp_notifica_descomposicion/test/integration/NavigationJourneyPhone",
		"cl/conchaytoro/zpp_notifica_descomposicion/test/integration/NotFoundJourneyPhone",
		"cl/conchaytoro/zpp_notifica_descomposicion/test/integration/BusyJourneyPhone"
	], function () {
		QUnit.start();
	});
});