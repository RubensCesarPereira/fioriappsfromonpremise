sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("cl/conchaytoro/zpp_libera_descomposicion/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("cl.conchaytoro.zpp_libera_descomposicion.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["cl/conchaytoro/zpp_libera_descomposicion/localService/mockserver"], function (mockserver) {
